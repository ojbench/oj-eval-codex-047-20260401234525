...
class ACMOJClient:
    ...
    def submit_file(self, problem_id: int, code_text: str, language: str = "cpp") -> Optional[Dict]:
...
def main():
    ...
    submit_file_parser = subparsers.add_parser("submit-file", help="Submit source code text")
    ...
    submit_file_parser.add_argument("--language", type=str, default="cpp", help="Language (e.g., cpp, c)")
    ...
    if args.command == "submit":
        ...
        try:
            ...
            return
        result = client.submit_file(args.problem_id, code_text, args.language)
